package com.wt.blockchain.domain.customer;

import com.alibaba.cola.domain.Entity;
import com.alibaba.cola.exception.BizException;
import lombok.Data;

import com.wt.blockchain.dto.domainmodel.*;

//Domain Entity can choose to extends the domain model which is used for DTO
@Data
@Entity
public class Customer extends com.wt.blockchain.dto.domainmodel.Customer{
