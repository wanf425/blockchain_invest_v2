package com.wt.blockchainivest.domain.customer;

import com.alibaba.cola.domain.Entity;
import com.alibaba.cola.exception.BizException;
import lombok.Data;

import com.wt.blockchainivest.dto.domainmodel.*;

//Domain Entity can choose to extends the domain model which is used for DTO
@Data
@Entity
public class Customer extends com.wt.blockchainivest.dto.domainmodel.Customer{
